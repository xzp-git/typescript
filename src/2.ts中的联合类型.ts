...
// !非空断言 表示这个东西一定有值,告诉ts按照我的想法来,如果后续出错我负责
// as / <> 直接强转某个类型,强制告诉人家 这个类型就是里面的某一个,强转要求必须联合类型中有才行
...
//jsx 语法 <div class={}>    <boolean>a  和 jsx冲突 所以不建议使用

(a as any) as boolean //双重断言 先进化成any 在转化成一个具体的类型,问题是会导致类型出问题
